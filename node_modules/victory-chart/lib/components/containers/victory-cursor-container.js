...
var cursorContainerMixin = exports.cursorContainerMixin = function (base) {
  var _class, _temp;
  ...
  return _temp = _class = function (_base) {
      ...
      value: function getPadding(props) {
        if ((0, _isUndefined3.default)(props.padding)) {
          var child = props.children.find(function (c) {
            return !(0, _isUndefined3.default)(c.props.padding);
          });
    ...
    cursorComponent: _react2.default.createElement(_victoryCore.Line, null)
    ...
    eventHandlers: {
      ...
      onMouseMove: function (evt, targetProps) {
        var mutations = _cursorHelpers2.default.onMouseMove(evt, targetProps);
