  ...
  return _temp = _class = function (_base) {
    ...
    _createClass(VictoryZoomContainer, [{
      ...
      value: function downsampleZoomData(props, childProps, domain) {
        ...
        var dimension = props.dimension || "x";
      ...
      value: function modifyChildren(props) {
        ...
        return childComponents.map(function (child) {
          ...
          var domain = void 0;
          if (!(0, _isEqual3.default)(zoomDomain, cachedZoomDomain)) {
          ...
          if (newDomain && props.dimension) {
            ...
            newDomain = _extends({}, zoomDomain, _defineProperty({}, props.dimension, newDomain[props.dimension]));
          }
    ...
    onDomainChange: _propTypes2.default.func,
    ...
    eventHandlers: {
      onMouseDown: function (evt, targetProps) {
        return _zoomHelpers2.default.onMouseDown(evt, targetProps);
      },
      onMouseUp: function (evt, targetProps) {
        return _zoomHelpers2.default.onMouseUp(evt, targetProps);
      },
      onMouseLeave: function (evt, targetProps) {
        return _zoomHelpers2.default.onMouseLeave(evt, targetProps);
      },
      onMouseMove: function (evt, targetProps, eventKey, ctx) {
        // eslint-disable-line max-params
        evt.preventDefault();
        var mutations = _zoomHelpers2.default.onMouseMove(evt, targetProps, eventKey, ctx);

        if (mutations.id !== _this3.mouseMoveMutationId) {
          // eslint-disable-line
          _this3.mouseMoveMutationId = mutations.id; // eslint-disable-line
      ...
      onWheel: function (evt, targetProps, eventKey, ctx) {
        ...
        var mutations = _zoomHelpers2.default.onWheel(evt, targetProps, eventKey, ctx);

        if (mutations.id !== _this3.wheelMutationId) {
          // eslint-disable-line
          _this3.wheelMutationId = mutations.id; // eslint-disable-line
          return mutations.mutations;
        }
