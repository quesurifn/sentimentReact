...
var VictoryContainer = function (_React$Component) {
  ...
  function VictoryContainer(props) {
    ...
    _this.containerId = typeof _this.props.containerId === "undefined" ? _uniqueId("victory-container-") : _this.props.containerId;
    return _this;
  }
  ...
  _createClass(VictoryContainer, [{
    ...
    value: function renderContainer(props, svgProps, style) {
      ...
      var parentProps = _defaults({ style: style, className: className }, svgProps);
    ...
    value: function render() {
      ...
      var style = responsive ? this.props.style : _omit(this.props.style, ["height", "width"]);
